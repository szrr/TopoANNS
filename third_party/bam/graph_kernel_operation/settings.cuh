...
Settings::Settings()
{
    ...
    // maxPageCacheSize = 8589934592; //8G
    // maxPageCacheSize = 17179869184;  //16G
    // maxPageCacheSize = 27917287424; //26G
    // maxPageCacheSize = 83886080; //80M
    // maxPageCacheSize = 41943040; //40M
    // maxPageCacheSize = 20971520; //20M
    // maxPageCacheSize = 10485760; //10M
}
